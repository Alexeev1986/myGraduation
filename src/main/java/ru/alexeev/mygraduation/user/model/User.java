package ru.alexeev.mygraduation.user.model;
...
public class User extends NamedEntity implements HasIdAndEmail {
    ...
    public User(Integer id, String name, String email, String password, boolean enabled, Date registered, @NotNull Collection<Role> roles) {
        super(id, name);
        this.email = email;
