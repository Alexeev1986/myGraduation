...
public class UserTestData {
    ...
    public static final String VOTER_MAIL = "voter@mail.ru";
    ...
    public static final User voter = new User(VOTER_ID, "Voter", VOTER_MAIL, "{noop}voter", true, new Date(), Role.USER);
